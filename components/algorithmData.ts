// Algorithm data with descriptions and images
export const imageProcessingAlgorithms = [
  {
    id: "object-detection",
...
export const soundProcessingAlgorithms = [
  {
    id: "audio-filtering",
    label: "Audio Filtering",
    description:
      "If audio like Gunshot, Siren, or any specific audio is detected then a real time action will be taken, provided our sound sensor is used.",
  ...
  },
  {
    ...
    description:
      "Language translation in real time. Provided our sound sensor is used.",
  ...
  },
  {
    ...
    description:
      "Reduces unwanted ambient sounds using active noise control techniques to improve audio clarity.",
  ...
  },
  {
    ...
    description:
      "Converts spoken language into text through linguistic algorithms and machine learning models.",
    image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c",
  },
  {
    id: "voice-analysis",
    ...
    description:
      "Analyzes voice patterns for authentication, emotion detection, or health assessment purposes.",
